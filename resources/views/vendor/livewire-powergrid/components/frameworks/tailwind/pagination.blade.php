            ...
            >
                <div class="flex justify-center mt-2 md:flex-none md:justify-end sm:mt-0">
                    ...
                    @if (!$paginator->onFirstPage())
                        <a
                            class="px-2 py-1 pt-2 m-1 text-center text-slate-700 dark:text-white  bg-pg-primary-600 border-pg-primary-400 rounded cursor-pointer border-1 hover:bg-pg-primary-600 hover:border-pg-primary-800 dark:text-pg-primary-300"
                            ...
                            @foreach ($element as $page => $url)
                                ...
                                @elseif (
                                    $page === $paginator->currentPage() + 1 ||
                                        ...
                                        $page === $paginator->currentPage() - 2)
                                    <a
                                        class="px-2 py-1 m-1 text-center text-slate-700 dark:text-white bg-pg-primary-600 border-pg-primary-400 rounded cursor-pointer border-1 hover:bg-pg-primary-600 hover:border-pg-primary-800 dark:text-pg-primary-300"
